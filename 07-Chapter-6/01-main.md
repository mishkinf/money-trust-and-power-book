...
Newton's 1717 report laid out the problem with characteristic precision. He had personally assayed foreign coins—Spanish pieces of eight, French louis d'or, Dutch guilders—measuring their metal content and calculating exchange ratios. His findings:
...
Under the classical gold standard, international payments did not require constant gold shipments. Most transactions settled through **bills of exchange**—the same instruments Italian merchants had pioneered centuries earlier. A London importer buying French wine would pay with a bill drawn on a Paris bank; a New York exporter selling cotton to Liverpool would receive a bill payable in sterling. These bills circulated, were discounted, and cleared through banking networks, with only **net imbalances** requiring gold settlement.²²

The system worked because exchange rates were fixed by each currency's gold content. The pound sterling contained 113 grains of pure gold; the U.S. dollar contained 23.22 grains. The exchange rate was therefore **$4.8665 per pound**—the ratio of their gold content. As long as both countries maintained convertibility, the rate could not deviate far from this parity.²³

The limits of deviation were called the **gold points**—the exchange rates at which it became profitable to ship gold rather than use bills of exchange. For dollar-sterling transactions after 1880, the gold points were approximately **1 percent** above and below parity. If the pound rose above $4.91, an American debtor would find it cheaper to buy gold in New York, ship it to London, and convert it to pounds than to buy pounds directly. If the pound fell below $4.82, the reverse arbitrage applied.²⁴

Within the gold points, exchange rates fluctuated based on supply and demand for bills of exchange. Outside the gold points, gold flowed automatically to correct imbalances. The system was **self-regulating**, requiring no central coordination. Or so the theory claimed.
