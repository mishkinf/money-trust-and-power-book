...
The second is redistribution. This function is contested in modern political debate but has deep historical roots: Mesopotamian debt jubilees, Biblical Jubilee laws, and Adam Smith's call for subjects to contribute "in proportion to their respective abilities." Societies that allowed extreme wealth concentration — Late Roman latifundia, medieval English enclosures — tended toward instability, and the question of how much redistribution monetary and fiscal institutions should perform has been recurring since at least 2400 BCE. The book takes no position on the right answer; it observes only that the question is older than the institutions that pose it.³⁰ᵇ⁻ᵈ

The Bank of England's founding showed the foundational sequence in operation. The government spent £1.2 million into existence by borrowing from the Bank. Those notes circulated because tax obligations created demand for them. Taxes did not fund the spending. Taxes made the spending valuable by ensuring everyone needed the notes.³⁰ᶠ ³⁰ᵍ⁻ʰ
