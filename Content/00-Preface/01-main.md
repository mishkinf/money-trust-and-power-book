...
What follows is not a polemic in that tradition's favor. The chapters take the opposing positions — Friedman's monetarism, the Currency School's worry about discretionary over-issuance, Buchanan and Wagner's public-choice critique, Sargent and Wallace's unpleasant monetarist arithmetic, John Cochrane's fiscal theory of the price level, Hayek's knowledge problem — on their own strongest terms before the book answers them. Some of those answers are concessions. The Currency School's central worry, that an issuer with discretionary power and a fiscal master will eventually over-issue, is the worry every fiat regime has to address by design; the historical record across Weimar, Argentina, Zimbabwe, Venezuela, and Turkey shows it is not paranoia. A reader picking up this book in the expectation of a credit-money cheerleading text will not find one. A reader picking it up in the expectation of a polemic against fiat money will not find that either.

The public conversation has not caught up. The 2021 inflation debate, the 2008 bailouts, the politics of government deficits, the recurring claim that a country has run out of money or that fiscal restraint requires household-budget thinking — all proceed as if money were still a fixed stock of metal-backed value, scarce by nature, that the state must acquire before it can spend. This book exists to close that gap. It is not a recovery of suppressed knowledge; it is a translation of a settled scholarly tradition for the readers who deserve to have it.
...
Readers familiar with Modern Monetary Theory — Stephanie Kelton's *The Deficit Myth*, L. Randall Wray's reconstruction of the chartalist tradition, Pavlina Tcherneva's work on the job guarantee — will recognize the credit-theory lineage this book extends. The chapters that follow assemble the historical foundation for the descriptive claims that lineage has been making: that taxation drives currency demand, that money is institutional credit, that productive capacity is the binding constraint on what currency-issuing governments can spend. The book provides the historical case for those claims. It does not also advocate the specific policy program — the federal job guarantee, the consolidated government balance sheet — that the modern MMT literature has built on top of them; those debates require their own arguments and their own books, and this is not one of them. What this book offers a Kelton-sympathetic reader is the historical and institutional foundation for the framework they already work with. What it offers a reader skeptical of that tradition is a chance to see how the historical record reads when assembled honestly, with the strongest opposing positions taken seriously on their own terms before the book answers them. Where the book has views — and on a question this consequential, no honest treatment can pretend it has none — those views emerge from the historical evidence rather than from prior commitment.
...
This is the sentence the chapters that follow are written to support. It will return at the close of each of the four Parts, as a thread the reader can hold across five thousand years.
