...
**Chapter Premise:** Keynes's bancor lost to White's dollar-centered system. The Triffin dilemma made the compromise unsustainable: the world needed dollar outflows for liquidity, but persistent deficits undermined gold convertibility. Nixon's 1971 closure of the gold window ended the system.
...
**This chapter examines Bretton Woods (1944) and its inevitable collapse, tracing how Keynes's bancor—a supranational currency with symmetric adjustment—lost to White's dollar-centered system backed by American gold.** We'll explore the conference's power dynamics (U.S. held 80% of global gold reserves), analyze why the compromise worked for 27 years but contained fatal contradictions, and document the Triffin dilemma: the world needed dollar outflows for liquidity, but persistent deficits undermined gold convertibility. The chapter reveals how de Gaulle's gold offensive, Britain's 1967 crisis, and the London Gold Pool's $3 billion hemorrhage culminated in Nixon's 1971 closure of the gold window—a "temporary" suspension that became permanent, ending the gold standard forever.
